...
public class EditInformation implements Task {
    ...
    public EditInformation (List<WebTableModel> model){
    ...
    public static EditInformation forRegister(List<WebTableModel> model){
        return Tasks.instrumented(EditInformation.class, model);
    }

    @Override
    public <T extends Actor> void performAs(T actor) {
        actor.attemptsTo(Click.on(WebTablePage.BTN_EDIT),
